    ...
    elem "network"
      ...
      [
        ...
        (subelem "forward"
          ...
          [
            (subelem "nat" [ (subattr "ipv6" typeBoolYesNo) ] [
              (subelem "address" [
            ...
            (subelem "pf" [ (subattr "dev" typeString) ] [ ])
            (subelem "address" [
        ...
        bandwidthElem
        (subelem "vlan" [ (subattr "trunk" typeBoolYesNo) ] [
          (subelem "tag" [
            (subattr "id" typeInt)
            (subattr "nativeMode" typeString)
          ] [ ])
        ])
        (subelem "port" [ (subattr "isolated" typeBoolYesNo) ] [ ])
        (subelem "portgroup"
          [
            (subattr "name" typeString)
          ...
          [
            (subelem "virtualport" [ (subattr "type" typeString) ] [
              (subelem "parameters" [
        ...
        (subelem "dns"
          ...
          [
            ...
            (subelem "host" [ (subattr "ip" typeString) ] [ (subelem "hostname" [ ] typeString) ])
            (subelem "srv" [
