            ...
            [
              ...
              (subelem "graphics"
                [
                  ...
                  (subattr "keymap" typeString)
                  (subattr "passwdValidTo" typeString)
                  (subattr "connected" typeString)
                  (subattr "defaultMode" typeString)
                  (subattr "socket" typeString)
                ]
                [
                  (subelem "listen" [ (subattr "type" typeString) (subattr "address" typeString) (subattr "network" typeString) (subattr "socket" typeString) ] [ ])
                  (subelem "image" [ (subattr "compression" typeString) ] [ ])
                  (subelem "channel" [ (subattr "name" typeString) (subattr "mode" typeString) ] [ ])
                  (subelem "jpeg" [ (subattr "compression" typeString) ] [ ])
                  (subelem "zlib" [ (subattr "compression" typeString) ] [ ])
                  (subelem "playback" [ (subattr "compression" typeBoolOnOff) ] [ ])
                  (subelem "streaming" [ (subattr "mode" typeString) ] [ ])
                  (subelem "clipboard" [ (subattr "copypaste" typeBoolYesNo) ] [ ])
                  (subelem "mouse" [ (subattr "mode" typeString) ] [ ])
                  (subelem "filetransfer" [ (subattr "enable" typeBoolYesNo) ] [ ])
