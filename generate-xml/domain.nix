let
  ...
  process =
    ...
    elem "domain" [ (subattr "type" typeString) ] [
      ...
      (subelem "vcpu" [
        (subattr "placement" typeString)
        (subattr "cpuset" typeString)
      ] (sub "count" typeInt))
      (subelem "iothreads" [ ] (sub "count" typeInt))
      (subelem "cputune" [ ] [
        (subelem "vcpupin" [
          (subattr "vcpu" typeInt)
          (subattr "cpuset" typeString)
        ] [ ])
        ...
        (subelem "vcpusched" [
          (subattr "vcpus" typeString)
          (subattr "scheduler" typeString)
          (subattr "priority" typeInt)
        ] [ ])
        (subelem "iothreadsched" [
          (subattr "iothreads" typeInt)
          (subattr "scheduler" typeString)
        ] [ ])
        ...
        (subelem "memorytune" [ (subattr "vcpus" typeString) ] [
          (subelem "node" [
            (subattr "id" typeInt)
            (subattr "bandwidth" typeInt)
          ] [ ])
        ])
      ])

      (subelem "sysinfo" [ (subattr "type" typeString) ] [
        (subelem "bios" [ ] [ (subelem "entry" [ (subattr "name" typeString) ] (sub "value" typeString)) ])
        (subelem "system" [ ] [
      ...
      (subelem "os" [ ] [
        (elem "type" [
          (subattr "arch" typeString)
          (subattr "machine" typeString)
        ] (sub "type" typeString))
        (subelem "loader" [
      ...
      (subelem "features" [ ] [
        ...
        (subelem "hyperv" [ (subattr "mode" typeString) ] [
          ...
          (subelem "spinlocks" [
            (subattr "state" typeBoolOnOff)
            (subattr "retries" typeInt)
          ] [ ])
      ...
      (subelem "cpu"
        ...
        [
          (subelem "model" [ (subattr "fallback" typeString) ] [ (sub "name" [ ] typeString) ])
          (subelem "topology" [
      ...
      (subelem "clock" [ (subattr "offset" typeString) ] [
        (subelem "timer"
          [
            (subattr "name" typeString)
      ...
      (
        ...
        subelem "devices" [ (subattr "type" typeString) ] [
              ...
              let
                backingStuff = [
                  ...
                  (subelem "backingStore" [ (subattr "type" typeString) ] (
                    [ (subelem "format" [ (subattr "type" typeString) ] [ ]) ] ++ backingStuff
                  ))
                ];
              in
              [
          ...
          (subelem "vsock" [ (subattr "model" typeString) ] [
            (subelem "cid" [
              (subattr "auto" typeBoolYesNo)
              (subattr "address" typeInt)
            ] [ ])
            addresselem
          ])
        ]
      )
      (sub "qemu-commandline" (
        elem "commandline" [ (attr "xmlns" (typeConstant "http://libvirt.org/schemas/domain/qemu/1.0")) ] [
      ...
      (sub "qemu-override" (
        elem "override" [ (attr "xmlns" (typeConstant "http://libvirt.org/schemas/domain/qemu/1.0")) ] [
          (subelem "device" [ (subattr "alias" typeString) ] [
            (subelem "frontend" [ ] [
              (subelem "property" [
                (subattr "name" typeString)
                (subattr "type" typeString)
